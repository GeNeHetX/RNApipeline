...
mv ref.gtf ensembl_v$Ensembel_ver_GRCh38_p13/ref.gtf
mv ref.fa.fai ensembl_v$Ensembel_ver_GRCh38_p13/ref.fa.fai
mv ref.dict ensembl_v$Ensembel_ver_GRCh38_p13/ref.dict
mv knowns_variants.vcf  ensembl_v$Ensembel_ver_GRCh38_p13/knowns_variants.vcf 
mv knowns_variants.vcf.idx ensembl_v$Ensembel_ver_GRCh38_p13/knowns_variants.vcf.idx
mv ref.fa ensembl_v$Ensembel_ver_GRCh38_p13/ref.fa
mv Exon_gtf_info.tab ensembl_v$Ensembel_ver_GRCh38_p13/Exon_gtf_info.tab
mv kalliso_index ensembl_v$Ensembel_ver_GRCh38_p13/kalliso_index
cp ref_build.sh ensembl_v$Ensembel_ver_GRCh38_p13/ref_data.sh


##generate a STAR index 
STAR --runThreadN 16 --runMode genomeGenerate --genomeDir ensembl_v$Ensembel_ver_GRCh38_p13 --genomeFastaFiles ensembl_v$Ensembel_ver_GRCh38_p13/ref.fa  --sjdbOverhang 100 --sjdbGTFfile ensembl_v$Ensembel_ver_GRCh38_p13/ref.gtf  --genomeSAindexNbases 11 
