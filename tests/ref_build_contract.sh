...
grep -q "utility: 'docker://genehetx/genehetx-rnaseq:v1.6.1'" "$ROOT_DIR/PrePostScripts/ref_build.nf"
grep -q "command -v curl" "$ROOT_DIR/PrePostScripts/ref_build.nf"
grep -q "command -v gzip" "$ROOT_DIR/PrePostScripts/ref_build.nf"
grep -q "command -v tar" "$ROOT_DIR/PrePostScripts/ref_build.nf"
