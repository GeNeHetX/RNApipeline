...
For this step you will need: 
     ...
     * Make sur that the FASTA and the GTF belongs to the same genome version !!
     * Know vcf file: Yo can retrive it from Ensembl Database. 
